                ...
                <div class="col-sm-6">
                    <form role="form" class="mb-2">
                        <div class="form-group">
                            <label for="sitiospark" class="fw-bolder fs-6 mb-2">Espacios Disponibles: </label>
                            <div class="input-group">
                                <span class="input-group-text">Disponibles</span>
                                <input type="number" class="form-control" min="0" max="100" name="sitiospark"
                                    id="sitiospark">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary my-2" id="sitioupdate"
                            name="sitioupdate">Actualizar Espacios</button>
                    </form>
                </div>
            </div>
        </div>
