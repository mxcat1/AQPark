            ...
            <div>
                <div class="border-bottom pb-4">
                    <div class="mb-2 mb-lg-0">
                        <h2 class="mb-0 fw-bold">VEHICULO - NUEVO</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="tab-content p-4">
                        <form action="{{route('Vehiculo.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="modelo" id="modelo" class="form-control" value="{{old('modelo')}}" placeholder="Indique el Modelos del Vehiculo">
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold" for="marca">Marca del Vehiculo</label>
                                <input type="text" name="marca" id="marca" class="form-control" value="{{old('marca')}}" placeholder="Indique la Marca del Vehiculo">
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold" for="color">Color del Vehiculo</label>
                                <input type="text" name="color" id="color" class="form-control" value="{{old('color')}}" placeholder="Indique el Color dlle Vehiculo">
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold" for="placa">Placa del Vehiculo</label>
                                <input type="text" name="placa" id="placa" class="form-control" value="{{old('placa')}}" placeholder="Indique la Placa del Vehiculo">
                            </div>
                            <div class="mb-3">
