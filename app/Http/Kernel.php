...
//        Se registro el Middleware para la administracion del sistema
        'authrol' => \App\Http\Middleware\UsuarioRolVerificacion::class,
        'logincontrol' => \App\Http\Middleware\UsuarioLoginControl::class,
